...
export default function Edit({attributes, setAttributes}) {
    ...
    if (effectiveAlignment && blockProps.className) {
        blockProps.className += ` align${effectiveAlignment}`;
    ...
    return (
        <>
            ...
            <InspectorControls>
                ...
                <TextControl
                    label={__("Image Border Radius", "image-box-block")}
                    value={imageBorderRadius}
                    onChange={(value) => setAttributes({imageBorderRadius: value})}
                    help={__(
                        "CSS border-radius value, e.g. 20px or 20px 20px 20px 20px",
                        "image-box-block"
                    )}
                />
            ...
            <div {...blockProps}>
                ...
                >
                    <div
                        ...
                        style={{marginBottom: imageSpace || undefined, width: "100%"}}
                    >
                        {imageUrl ? (
                            <img
                                src={imageUrl}
