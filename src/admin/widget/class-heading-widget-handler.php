...
$text_transform     = isset( $settings['typography_text_transform'] ) ? trim( (string) $settings['typography_text_transform'] ) : '';
        ...
        if ( '' !== $text_transform ) {
            $transform_class = Style_Parser::clean_class( 'has-text-transform-' . $text_transform );
            if ( '' !== $transform_class ) {
                $class_names[]     = $transform_class;
                $element_classes[] = $transform_class;
            }
        }
